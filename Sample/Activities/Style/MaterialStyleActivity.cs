...
namespace Sample.Activities.Style
{
    ...
    public class MaterialStyleActivity : AppCompatActivity, IOnItemClickListener
    {
        private class Item
        {
            // switch case
            ...
            public const string 打开背景 = "打开背景";
            public const string 关闭背景 = "关闭背景";
            ...
            public static List<Item> List = new List<Item>{
                ...
                new Item(打开背景, "下拉的时候绘制贝塞尔曲线背景"),
                new Item(关闭背景, "下拉的时候不绘制贝塞尔曲线背景"),
