...
{
    [Activity(Label = "@string/title_activity_style_water_drop")]
    public class WaterDropStyleActivity : AppCompatActivity, IOnItemClickListener
    {
        private class Item
        {
            // switch case
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.activity_style_water_drop);
