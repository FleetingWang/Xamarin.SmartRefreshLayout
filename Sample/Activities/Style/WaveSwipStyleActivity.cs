...
{
    [Activity(Label = "@string/title_activity_style_wave_swip")]
    public class WaveSwipStyleActivity : AppCompatActivity, IOnItemClickListener
    {
        private class Item
        {
            // switch case
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.activity_style_wave_swip);
