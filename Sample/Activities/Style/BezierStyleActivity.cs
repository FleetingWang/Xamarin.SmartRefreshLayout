...
{
    [Activity(Label = "@string/title_activity_style_bezier")]
    public class BezierStyleActivity : AppCompatActivity, IOnItemClickListener
    {
        private class Item
        {
            // switch case
            ...
            public const string 打开左右拖动 = "打开左右拖动";
            public const string 关闭左右拖动 = "关闭左右拖动";
            public static List<Item> List = new List<Item>{
                ...
                new Item(打开左右拖动, "打开左右拖动效果"),
                new Item(关闭左右拖动, "关闭左右拖动效果")
            };
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.activity_style_bezier);
            ...
            mRefreshHeader = FindViewById(Resource.Id.header) as BezierRadarHeader;
            if (isFirstEnter)
            {
                isFirstEnter = false;
