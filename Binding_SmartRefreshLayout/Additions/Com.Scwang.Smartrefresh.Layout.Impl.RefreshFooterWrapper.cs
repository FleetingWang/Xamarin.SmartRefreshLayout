...
namespace Com.Scwang.Smartrefresh.Layout.Impl {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.scwang.smartrefresh.layout.impl']/class[@name='RefreshFooterWrapper']"
	[global::Android.Runtime.Register ("com/scwang/smartrefresh/layout/impl/RefreshFooterWrapper", DoNotGenerateAcw=true)]
	public partial class RefreshFooterWrapper : global::Java.Lang.Object, global::Com.Scwang.Smartrefresh.Layout.Api.IRefreshFooter {

		internal            static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("com/scwang/smartrefresh/layout/impl/RefreshFooterWrapper", typeof (RefreshFooterWrapper));
		...
		protected RefreshFooterWrapper (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.scwang.smartrefresh.layout.impl']/class[@name='RefreshFooterWrapper']/constructor[@name='RefreshFooterWrapper' and count(parameter)=1 and parameter[1][@type='android.view.View']]"
		[Register (".ctor", "(Landroid/view/View;)V", "")]
		public unsafe RefreshFooterWrapper (global::Android.Views.View wrapper)
...
#pragma warning disable 0169
		...
		{
			global::Com.Scwang.Smartrefresh.Layout.Impl.RefreshFooterWrapper __this = global::Java.Lang.Object.GetObject<global::Com.Scwang.Smartrefresh.Layout.Impl.RefreshFooterWrapper> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.IsSupportHorizontalDrag;
		}
#pragma warning restore 0169

		public virtual unsafe bool IsSupportHorizontalDrag {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.scwang.smartrefresh.layout.impl']/class[@name='RefreshFooterWrapper']/method[@name='isSupportHorizontalDrag' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Com.Scwang.Smartrefresh.Layout.Constant.SpinnerStyle SpinnerStyle {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.scwang.smartrefresh.layout.impl']/class[@name='RefreshFooterWrapper']/method[@name='getSpinnerStyle' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Android.Views.View View {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.scwang.smartrefresh.layout.impl']/class[@name='RefreshFooterWrapper']/method[@name='getView' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.scwang.smartrefresh.layout.impl']/class[@name='RefreshFooterWrapper']/method[@name='isTagedFooter' and count(parameter)=1 and parameter[1][@type='android.view.View']]"
		[Register ("isTagedFooter", "(Landroid/view/View;)Z", "")]
		public static unsafe bool IsTagedFooter (global::Android.Views.View view)
		{
			const string __id = "isTagedFooter.(Landroid/view/View;)Z";
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [1];
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.scwang.smartrefresh.layout.impl']/class[@name='RefreshFooterWrapper']/method[@name='onFinish' and count(parameter)=2 and parameter[1][@type='com.scwang.smartrefresh.layout.api.RefreshLayout'] and parameter[2][@type='boolean']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.scwang.smartrefresh.layout.impl']/class[@name='RefreshFooterWrapper']/method[@name='onHorizontalDrag' and count(parameter)=3 and parameter[1][@type='float'] and parameter[2][@type='int'] and parameter[3][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.scwang.smartrefresh.layout.impl']/class[@name='RefreshFooterWrapper']/method[@name='onInitialized' and count(parameter)=3 and parameter[1][@type='com.scwang.smartrefresh.layout.api.RefreshKernel'] and parameter[2][@type='int'] and parameter[3][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.scwang.smartrefresh.layout.impl']/class[@name='RefreshFooterWrapper']/method[@name='onPullReleasing' and count(parameter)=4 and parameter[1][@type='float'] and parameter[2][@type='int'] and parameter[3][@type='int'] and parameter[4][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.scwang.smartrefresh.layout.impl']/class[@name='RefreshFooterWrapper']/method[@name='onPullingUp' and count(parameter)=4 and parameter[1][@type='float'] and parameter[2][@type='int'] and parameter[3][@type='int'] and parameter[4][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.scwang.smartrefresh.layout.impl']/class[@name='RefreshFooterWrapper']/method[@name='onStartAnimator' and count(parameter)=3 and parameter[1][@type='com.scwang.smartrefresh.layout.api.RefreshLayout'] and parameter[2][@type='int'] and parameter[3][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.scwang.smartrefresh.layout.impl']/class[@name='RefreshFooterWrapper']/method[@name='onStateChanged' and count(parameter)=3 and parameter[1][@type='com.scwang.smartrefresh.layout.api.RefreshLayout'] and parameter[2][@type='com.scwang.smartrefresh.layout.constant.RefreshState'] and parameter[3][@type='com.scwang.smartrefresh.layout.constant.RefreshState']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.scwang.smartrefresh.layout.impl']/class[@name='RefreshFooterWrapper']/method[@name='setLoadmoreFinished' and count(parameter)=1 and parameter[1][@type='boolean']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.scwang.smartrefresh.layout.impl']/class[@name='RefreshFooterWrapper']/method[@name='setPrimaryColors' and count(parameter)=1 and parameter[1][@type='int...']]"
